 ...
 */
class TranslationSet implements Countable, Iterator
{
    /**
     * @var array
     */
     ...
     */
    public function addTranslation($sourceString, $translatedString)
    {
        $this->translations[$sourceString] = $translatedString;
        $this->current = $sourceString;
    }
